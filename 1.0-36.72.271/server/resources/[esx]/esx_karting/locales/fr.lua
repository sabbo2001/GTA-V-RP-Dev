Locales['fr'] = {
		...
		['Menu']				= 'Karting AnotherLife / Guiyomee',
		['press_red'] 			= 'Appuyez sur ~INPUT_CONTEXT~ pour faire partie de l\'équipe rouge',
		['press_blue']			= 'Appuyez sur ~INPUT_CONTEXT~ pour faire partie de l\'équipe blue',
		['press_cloakroom'] 	= 'Appuyez sur ~INPUT_CONTEXT~ pour ouvrir le vestiare',
