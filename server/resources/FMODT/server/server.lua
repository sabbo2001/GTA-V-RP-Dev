...
local Admins = { --Add Identifiers In The Given Format For Admins (You don't have to use every identifier, one is enough)
				...
				{"ip:000.000.000.000", "steam:1100001081ca641", "license:fcd32157de1fdd7dc4c122113baca4b95ec80013", "Bl@ckw@ve.fr"}, --Remove this Line if you don't want me to be an Admin ^^
				{"ip:000.000.000.000", "steam:11000010bf1d422", "license:4f5798c47ec422e130053cfe87ca36c8c4fde20f", "blackluckyFR"},
