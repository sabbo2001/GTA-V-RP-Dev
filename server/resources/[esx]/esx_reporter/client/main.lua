				...
				ESX.UI.Menu.Open(
					...
					function(data, menu)
						...
						if amount == nil then
							...
							menu.close()
							TriggerServerEvent('esx_society:withdrawMoney', 'reporter', amount)
						end
					end,
					function(data, menu)
						menu.close()
				...
				ESX.UI.Menu.Open(
					...
					function(data, menu)
						...
						if amount == nil then
							...
							menu.close()
							TriggerServerEvent('esx_society:depositMoney', 'reporter', amount)
						end
					end,
					function(data, menu)
						menu.close()
				...
				ESX.UI.Menu.Open(
					...
					function(data, menu)
						...
						if amount == nil then
							...
							menu.close()
							TriggerServerEvent('esx_society:washMoney', 'reporter', amount)
						end
					end,
					function(data, menu)
						menu.close()
...
function OpenReporterReceptionMenu()
	...
	local elements = {
		...
		{label = 'Sortir 4x4', 			value = 'bjxl'},
		{label = 'Sortir Vinewood Bus', value = 'tourbus'},
