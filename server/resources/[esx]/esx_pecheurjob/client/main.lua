	...
	ESX.UI.Menu.Open(
		'default', GetCurrentResourceName(), 'cloakroom',
		{
			...
			elements = {
				...
				{label = _U('vine_clothes_vine'), value = 'peche_wear'},
			},
		},
		function(data, menu)
...
AddEventHandler('esx_pecheurjob:hasEnteredMarker', function(zone)
	if zone == 'PecheFarm' and PlayerData.job ~= nil and PlayerData.job.name == 'peche'  then
		CurrentAction     = 'poissons_harvest' 
		CurrentActionMsg  = _U('press_collect')
		CurrentActionData = {zone= zone}
	end
		
	if zone == 'Traitementpoissonlave' and PlayerData.job ~= nil and PlayerData.job.name == 'peche'  then
		CurrentAction     = 'poissons_traitement'    
		CurrentActionMsg  = _U('press_collect')
		CurrentActionData = {zone= zone}
	end		
		
	if zone == 'Traitementpoissonprepare' and PlayerData.job ~= nil and PlayerData.job.name == 'peche'  then
		CurrentAction     = 'poissons_prepare_traitement'		
	...
	if zone == 'PecheurActions' and PlayerData.job ~= nil and PlayerData.job.name == 'peche' then
		CurrentAction     = 'peche_actions_menu'
		CurrentActionMsg  = _U('press_to_open')
		CurrentActionData = {}
	end
...
AddEventHandler('esx_pecheurjob:hasExitedMarker', function(zone)
	...
	if (zone == 'TraitementVin' or zone == 'TraitementJus') and PlayerData.job ~= nil and PlayerData.job.name == 'peche' then
...
function blips()
	if publicBlip == false then
		...
		AddTextComponentString("Pecheurs")
