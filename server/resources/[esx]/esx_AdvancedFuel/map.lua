...
local blips = {
    ...
    ---- Boatpécheur ----
	{name=blipNameFuelBoat, id=427,x = 3921.9736328125, y = 4511.40625, z = 3.2983956336975},
...
boat_stations = {
	...
	{x=3921.9736328125,y=4511.40625,z=3.2983956336975,s=35},
}
...
stationsText[34] = {x = 3888.3, y = 4468.09, z = 0.0}
stationsText[35] = {x = 3867.44, y = 4463.62, z = 1.72386}
