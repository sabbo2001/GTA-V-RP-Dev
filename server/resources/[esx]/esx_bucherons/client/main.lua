...
AddEventHandler('esx_bucherons:hasEnteredMarker', function(zone)
	if zone == 'feuilletabFarm' and PlayerData.job ~= nil and PlayerData.job.name == 'buche'  then
		CurrentAction     = 'feuilletab_harvest'
		CurrentActionMsg  = _U('press_collect')
		CurrentActionData = {zone= zone}
	end
		
	if zone == 'TraitementVin' and PlayerData.job ~= nil and PlayerData.job.name == 'buche'  then
	...
	if zone == 'tabacActions' and PlayerData.job ~= nil and PlayerData.job.name == 'buche' then
		CurrentAction     = 'tabac_actions_menu'
		CurrentActionMsg  = _U('press_to_open')
		CurrentActionData = {}
	end
...
AddEventHandler('esx_bucherons:hasExitedMarker', function(zone)
	...
	if (zone == 'TraitementVin' or zone == 'TraitementJus') and PlayerData.job ~= nil and PlayerData.job.name == 'buche' then
